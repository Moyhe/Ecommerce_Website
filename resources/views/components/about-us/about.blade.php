        ...
        <div class="flex flex-wrap ">
            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div class="relative">
                    ...
                    <div
                        class="absolute z-50 text-red-400 transform -translate-y-1/2 cursor-pointer top-1/2 left-[46%] hover:text-red-500">
            ...
            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                ...
                <a href="#"
                    class="px-4 py-3 text-gray-50 transition-all transform bg-red-400 rounded-[80px] hover:bg-red-500 dark:hover:text-gray-100 dark:text-gray-100 ">
                    Learn more
                </a>
            </div>
        </div>
